...
export class UsersComponent implements OnInit {
    ...
    public displayedColumns: string[] = ['name', 'email', 'address', 'books', 'penalty', 'actions'];
    public dataSource: MatTableDataSource<IUserView> = new MatTableDataSource(undefined);
